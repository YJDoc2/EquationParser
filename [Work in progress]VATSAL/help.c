...
void main()
{
    ...
    printf("----->In case of 0 as co-efficient or constant write 1*10^-6 to 1*10^-36.  Example: 0.0000000000001\n----->If determinant is zero 0 then linear system of equations is not consistent, therefore solutions will not exits or will have infinite no. of solutions.\n");
